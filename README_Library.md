...
1. Fork the template repository to use as a starting point.
  * Navigate to https://github.com/unlishema/SimpleKeyHandler in your browser.
...
### Option B: Downloaded Package (You must also copy over the source of SimpleKeyHandler once setup)
